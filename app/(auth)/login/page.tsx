  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <nav className="flex items-center justify-between px-8 py-5 bg-white border-b border-gray-100">
        ...
        <Link href="/signup" className="text-sm font-medium text-orange-600 hover:text-orange-700">
          Create account →
        </Link>
      </nav>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-500 text-sm mb-8">Sign in to your outvgo account</p>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            No account?{' '}
            <Link href="/signup" className="text-orange-600 font-medium hover:text-orange-700">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
